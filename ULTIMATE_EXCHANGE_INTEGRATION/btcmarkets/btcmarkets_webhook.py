#!/usr/bin/env python3
"""
BTC Markets Webhook Handler
Handles real-time notifications from BTC Markets
"""
...
class BTCMarketsWebhookHandler:
    ...
    def setup_logging(self):
        ...
        self.logger = logging.getLogger(f"btcmarkets_webhook")
    
    def verify_signature(self, payload: str, signature: str) -> bool:
        """Verify webhook signature"""
        try:
            secret = os.getenv('BTCMARKETS_WEBHOOK_SECRET', '')
...
handler = BTCMarketsWebhookHandler()

@app.route('/webhook/btcmarkets/order', methods=['POST'])
def order_webhook():
...
@app.route('/webhook/btcmarkets/balance', methods=['POST'])
def balance_webhook():
