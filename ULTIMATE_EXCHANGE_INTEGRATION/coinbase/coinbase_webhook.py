...
Handles real-time notifications from Coinbase
"""
...
class CoinbaseWebhookHandler:
    ...
    def setup_logging(self):
        ...
        self.logger = logging.getLogger(f"coinbase_webhook")
...
handler = CoinbaseWebhookHandler()

@app.route('/webhook/coinbase/order', methods=['POST'])
def order_webhook():
...
@app.route('/webhook/coinbase/balance', methods=['POST'])
def balance_webhook():
