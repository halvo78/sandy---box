...
Handles real-time notifications from Binance
"""
...
class BinanceWebhookHandler:
    ...
    def setup_logging(self):
        ...
        self.logger = logging.getLogger(f"binance_webhook")
...
@app.route('/webhook/binance/order', methods=['POST'])
def order_webhook():
...
@app.route('/webhook/binance/balance', methods=['POST'])
def balance_webhook():
