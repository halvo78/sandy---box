#!/usr/bin/env python3
"""
WhiteBIT Webhook Handler
Handles real-time notifications from WhiteBIT
"""
...
class WhiteBITWebhookHandler:
    ...
    def setup_logging(self):
        ...
        self.logger = logging.getLogger(f"whitebit_webhook")
    
    def verify_signature(self, payload: str, signature: str) -> bool:
        """Verify webhook signature"""
        try:
            secret = os.getenv('WHITEBIT_WEBHOOK_SECRET', '')
...
handler = WhiteBITWebhookHandler()

@app.route('/webhook/whitebit/order', methods=['POST'])
def order_webhook():
...
@app.route('/webhook/whitebit/balance', methods=['POST'])
def balance_webhook():
