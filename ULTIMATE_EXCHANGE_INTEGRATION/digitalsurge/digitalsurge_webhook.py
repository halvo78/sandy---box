#!/usr/bin/env python3
"""
DigitalSurge Webhook Handler
Handles real-time notifications from DigitalSurge
"""
...
class DigitalSurgeWebhookHandler:
    def __init__(self):
    ...
    def setup_logging(self):
        ...
        self.logger = logging.getLogger(f"digitalsurge_webhook")
    
    def verify_signature(self, payload: str, signature: str) -> bool:
        """Verify webhook signature"""
        try:
            secret = os.getenv('DIGITALSURGE_WEBHOOK_SECRET', '')
...
handler = DigitalSurgeWebhookHandler()

@app.route('/webhook/digitalsurge/order', methods=['POST'])
def order_webhook():
...
@app.route('/webhook/digitalsurge/balance', methods=['POST'])
def balance_webhook():
