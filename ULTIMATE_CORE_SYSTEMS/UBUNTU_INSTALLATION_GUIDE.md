...
# tar -xzf YOUR_API_KEY_HERE.tar.gz --strip-components=1
...
echo "Please transfer the YOUR_API_KEY_HERE.tar.gz file to this directory"
echo "Then run: tar -xzf YOUR_API_KEY_HERE.tar.gz --strip-components=1"
...
ENCRYPTION_KEY=YOUR_API_KEY_HERE
