...
class FailoverSystem:
    ...
    async def _perform_health_check(self):
        ...
        # Database health
        try:
            conn = sqlite3.connect("/home/ubuntu/YOUR_API_KEY_HERE/logs/logs.db")
            cursor = conn.cursor()
    ...
    async def _create_emergency_backup(self):
        ...
        try:
            ...
            critical_files = [
                "/home/ubuntu/YOUR_API_KEY_HERE/config/.env",
                "/home/ubuntu/YOUR_API_KEY_HERE/logs/logs.db",
                "/home/ubuntu/YOUR_API_KEY_HERE/logs/trade_replay/trades.db"
            ]
