...
def main():
    ...
    print('vault kv put secret/exchanges/binance API_KEY="YOUR_API_KEY_HERE" api_secret="YOUR_BINANCE_SECRET" mode="LIVE"')
    ...
    print('vault kv put secret/exchanges/whitebit API_KEY="YOUR_API_KEY_HERE" api_secret="YOUR_WHITEBIT_SECRET" mode="LIVE"')
    print('vault kv put secret/exchanges/btcmarkets API_KEY="YOUR_API_KEY_HERE" api_secret="YOUR_BTCMARKETS_SECRET" mode="LIVE"')
