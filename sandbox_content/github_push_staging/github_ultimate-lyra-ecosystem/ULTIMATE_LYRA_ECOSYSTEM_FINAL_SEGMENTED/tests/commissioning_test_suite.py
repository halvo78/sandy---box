...
class CommissioningTestSuite:
    ...
    async def _test_api_signature_validation(self) -> Tuple[bool, str, float]:
        ...
        try:
            ...
            test_message = "symbol=BTCUSDT&side=BUY&type=MARKET&quantity=0.1&timestamp=+1-XXX-XXX-XXXX"
            ...
            if len(signature) == 64 and all(c in '+1-XXX-XXX-XXXXabcdef' for c in signature):
                latency = (time.time() - start_time) * 1000
